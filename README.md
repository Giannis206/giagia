...
Πρόσθεσε δικές σου λέξεις στα `data/words_N.txt` (μία λέξη ανά γραμμή, κεφαλαία ελληνικά, χωρίς τόνους). Κάθε αρχείο πρέπει να περιέχει λέξεις μήκους `N` μόνο.

## Σημειώσεις

- Προεπιλογή πλέγματος: **11×11** (μεγαλύτερα κελιά για άτομα με χαμηλή όραση)
